...
public class SelfBalancingBST
{
	...
	private SBBSTNode rotateWithLeftChild(SBBSTNode k)
	{
		SBBSTNode k1 = k.left;
		k.left = k1.right;
		k1.right = k;
	...
	private SBBSTNode rotateWithRightChild(SBBSTNode k)
	{
		SBBSTNode k1 = k.right;
		k.right = k1.left;
		k1.left = k;
		k.height = max(height(k.left), height(k.right)) + 1;
	...
	private SBBSTNode doubleWithLeftChild(SBBSTNode k)
	{
	...
	private SBBSTNode doubleWithRightChild(SBBSTNode k)
	{
